...
<script type="text/javascript" src="/aquadat-web/themes/bootstrap/js/jquery.yiigridview.js"></script>
	<?php 
...
<link rel="shortcut icon" href="/aquadat-web/favicon.ico">
<style>
...
@font-face {
    ...
    src: url('/aquadat-web/fonts/sukhumvitreg-webfont.eot');
    src: url('/aquadat-web/fonts/sukhumvitreg-webfont?#iefix') format('embedded-opentype'),
         url('/aquadat-web/fonts/sukhumvitreg-webfont.woff') format('woff'),
         url('/aquadat-web/fonts/sukhumvitreg-webfont.ttf') format('truetype'),
         url('/aquadat-web/fonts/sukhumvitreg-webfont.svg#quarkbold') format('svg');
    font-weight: normal;
    font-style: normal;
...
@font-face {
    font-family: 'Boon400';
    src: url('/aquadat-web/fonts/boon-400.eot');
    src: url('/aquadat-web/fonts/boon-400.eot') format('embedded-opentype'),
         url('/aquadat-web/fonts/boon-400.woff') format('woff'),
         url('/aquadat-web/fonts/boon-400.ttf') format('truetype'),
         url('/aquadat-web/fonts/boon-400.svg#Boon400') format('svg');
}

@font-face {
    font-family: 'Boon700';
    src: url('/aquadat-web/fonts/boon-700.eot');
    src: url('/aquadat-web/fonts/boon-700.eot') format('embedded-opentype'),
         url('/aquadat-web/fonts/boon-700.woff') format('woff'),
         url('/aquadat-web/fonts/boon-700.ttf') format('truetype'),
         url('/aquadat-web/fonts/boon-700.svg#Boon700') format('svg');
}

@font-face {
    font-family: 'THSarabunPSK';
    src: url('/aquadat-web/fonts/thsarabunnew-webfont.eot');
    src: url('/aquadat-web/fonts/thsarabunnew-webfont.eot') format('embedded-opentype'),
         url('/aquadat-web/fonts/thsarabunnew-webfont.woff') format('woff'),
         url('/aquadat-web/fonts/thsarabunnew-webfont.ttf') format('truetype');
    ...
    'items'=>array(
        ...
        array(
            ...
            'buttons'=>array(
                    ...
                    array('items'=>array(
                        array('label'=>'เปลี่ยนรหัสผ่าน','icon'=>'cog', 'url'=>array('/user/password/'.Yii::app()->user->ID), 'visible'=>!Yii::app()->user->isUser()),
                        '---',
                        array('label'=>'ออกจากระบบ','icon'=>'off', 'url'=>array('/site/logout'), 'visible'=>Yii::app()->user->isUser()),
                    )),
                ),
